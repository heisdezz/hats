        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-base-content/60 mt-0.5">
              Add handcrafted millinery or fine jewelry to your luxury catalog.
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="card-body p-6 space-y-4">
                  ...
                  <label className="flex items-start gap-3 cursor-pointer p-3 rounded-xl bg-base-200/50 hover:bg-base-200 transition-colors border border-base-200">
                    ...
                    <div className="text-xs space-y-0.5">
                      <p className="font-bold text-base-content">Publish Immediately</p>
                      <p className="text-base-content/60">
                        When enabled, this product is immediately discoverable in the store catalog.
                      </p>
                    </div>
                  </label>
                </div>
              ...
              <div className="card bg-base-100 border border-base-200 shadow-xs">
                <div className="card-body p-6 space-y-3">
                  <div className="flex items-center justify-between pb-2 border-b border-base-200">
                    ...
                    <span className="text-xs text-base-content/50">Multi-image upload</span>
                  </div>
                  <UpdateImages
                    images={[]}
                    setNew={setNewImages}
              ...
              <div className="card bg-base-100 border border-base-200 shadow-xs">
                <div className="card-body p-6 space-y-3">
                  ...
                  <div className="border border-base-200 rounded-2xl overflow-hidden bg-base-100 shadow-xs">
                    <div className="aspect-square bg-base-200/70 flex items-center justify-center text-base-content/30 relative">
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                >
                  {mutation.isPending ? (
                    ...
                    <>
                      <CheckCircle2 className="size-4" /> Create Product
                    </>
                  )}
                </button>
              </div>
